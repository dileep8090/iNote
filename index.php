<?php  
// INSERT INTO `data` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'But Books', 'Please buy books from Store', current_timestamp());
$insert = false;
$update = false;
$delete = false;
  ...
  <div class="container my-4">
    ...
    <form action="/crud/index.php" method="POST">
        <div class="card-header bg-primary">
                    <h2 class="text-white text-center mb-s">Add Notes</h2>
                </div>
